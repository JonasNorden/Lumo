...
function normalizeRuntimeStoneAreas(levelDocument) {
  const areas = Array.isArray(levelDocument?.stoneAreas) ? levelDocument.stoneAreas : [];
  return areas
    .map((area, index) => {
...
function normalizeRuntimeDustAreas(levelDocument) {
  const areas = Array.isArray(levelDocument?.dustAreas) ? levelDocument.dustAreas : [];
  return areas
    .map((area, index) => {
...
function normalizeRuntimeSmokeAreas(levelDocument) {
  const areas = Array.isArray(levelDocument?.smokeAreas) ? levelDocument.smokeAreas : [];
  return areas
    .map((area, index) => {
