...
// Reads raw JSON text from either filesystem paths or HTTP/HTTPS URLs.
...
// Starts Recharged runtime from a level JSON path/URL by reusing loader + document start API.
